 ...
 * Рассмотрим поведение GC относительно soft (безопасных) ссылок на объекты.
 */
public class SoftDemo {
     ...
     * с переопределённым методом finalize и полем типа String.
     * Срабатывает GC и фиксируем количество выживших объектов
     * после дефицита heap и срабатывания GC.
     */
     ...
     */
    private static void softRefUsage() throws IOException {
