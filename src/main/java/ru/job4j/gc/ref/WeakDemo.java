 ...
 * Рассмотрим поведение GC относительно weak (слабых) ссылок на объекты.
 */
public class WeakDemo {
    ...
    /**
     * Метод создаёт объект с сильной ссылкой.
     * Далее создаём слабую ссылку на этот объект.
     * При занулении сильной ссылки, происходит удаление объекта.
     *
    ...
    /**
     * Создаётся сильная ссылка на список объектов со слабыми ссылками.
     * Вызываем GC и он удаляет объекты со слабыми ссылками,
     * несмотря на то, что на них ещё осталась живая сильная ссылка.
     *
